export default () => {
    ...
    const noSocialsWrapper = document.createElement('div')
    noSocialsWrapper.classList.add( 'no-socials-div', 'py-3', 'px-4', 'mb-2', 'bg-gray-300', 'rounded', 'font-bold', 'text-sm')
    ...
    noSocialsWrapper.append(noSocialsContent, brk, btn)

    return noSocialsWrapper
}